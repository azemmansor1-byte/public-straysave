...
void main() {
  ...
  group('Register Test', () {
    ...
    testWidgets(
      'Pressing Register calls AuthService.registerWithEmailAndPassword',
      (tester) async {
        final mockAuth = MockAuthService();
        when(
          () =>
              mockAuth.registerWithEmailAndPassword(any(), any(), any(), any()),
        ...
        await tester.pump();
        verify(
          () => mockAuth.registerWithEmailAndPassword(
            'username',
            'test@email.com',
            'abcd1234',
            '+60123456789',
